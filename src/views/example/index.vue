  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="操作人姓名"
                v-model="listQuery.crtName"></el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row
      ...
      <el-table-column width="150px" align="center" label="菜单">
        <template slot-scope="scope">
      ...
      <el-table-column width="150px" align="center" label="资源路径">
        <template slot-scope="scope">
      ...
      <el-table-column width="80px" align="center" label="操作人ID">
        <template slot-scope="scope">
      ...
      <el-table-column width="130px" align="center" label="操作主机">
        <template slot-scope="scope">
